    ...
    <main>
      ...
      <div>
        ...
        <p>
          ...
          Although my title is UX designer, my work has consisted of about equal
          parts of UX design and web front- end development. I have been
        ...
        <p>
          During the past few years, I have been working e.g. with the following
          technologies: React, Redux, Angular (1.x and 2+), TypeScript,
          Bootstrap, Webpack, SVG, Sass and Jest. I am very familiar with
          version control (Git), CI (TeamCity), and many JS libraries (e.g.
          Lodash, Moment.js, Highcharts and Leaflet). Although my focus has been
          on the front-end, I have also done C# back-end development with .NET
          and EF, including .NET Core, and designed several REST APIs. I also
          have some experience with React Native and mobile development.
        </p>
        ...
        <p>
          ...
          and test my designs. I have created mockups and prototypes for web and
          mobile apps, written user stories and other specs, and created visual
          designs with Photoshop. I am competent with responsive design and
          patterns used in modern web applications. I also know how to analyze
      ...
      <div>
        ...
        <p>
          ...
          Science and Engineering. My major was in media technology with a focus
          on user interfaces and usability. I wrote my master's thesis about{' '}
      ...
      <div>
        ...
        <p>
          I am secretary in our scout group Munksnäs Spejarna and have been the
          main organizer of multiple camps and other events. In 2014, I was the
          vice chief for Atlantis, a one-week scout camp with almost 2000
          participants. Over 200 adults were involved in the planning phase and
          over 600 had assignments during the camp. I learned how to set up
          goals, build and lead a project team, and work efficiently in a
          distributed organization. The camp was very successful, with a 4.3
